...
const Footer = () => {
    ...
    return (
        <div className='w-full bg-[#1053D4] h-[60vh] flex items-center justify-center pb-[50px]'>
            <div className='w-[90%] flex flex-col items-center gap-[20px] max-[650px]:w-full '>
                <div className="flex items-center justify-between w-[100%] max-[650px]:justify-center">
                    <img src="/footerlogo.svg" alt="" className="max-[650px]:mt-[50px]"/>
                ...
                <span className="flex w-[95%] h-[2px] bg-[#3C7FFF] max-[650px]:hidden "></span>
                ...
                <div className="w-full flex items-center justify-center text-white gap-[10px] max-[650px]:text-[12px] max-[650px]:flex-col">
                    ...
                    <span className="flex w-[2px] h-[10px] bg-[#3C7FFF]  max-[650px]:hidden"></span>
